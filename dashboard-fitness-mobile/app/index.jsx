        ...
        <View style={{ flex: 1, justifyContent: 'flex-end' }}>
            ...
            >
                ...
                <Animated.View entering={FadeInDown.delay(200).springify()} style={{ alignItems: 'center' }}>
                    <TouchableOpacity style={{ height: hp(7), width: wp(80), backgroundColor: '#f43f5e', alignItems: 'center', justifyContent: 'center', borderRadius: 9999, borderWidth: 2, borderColor: '#d4d4d8' }}>
